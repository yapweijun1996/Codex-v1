            ...
            examples: [
              {
                user: [
                  "{",
                  "  \"question\": \"help me check the document number 'SIV12398'\",
                  "  \"plan\": [\"clarify\", \"sql_sal_inv\", \"summary\"],",
                  "  \"clarify_question\": null,",
                  "  \"sql_executed\": \"SELECT\\n  s.dnum_auto AS document_number,\\n  s.party_desc AS customer_name,\\n  s.date_trans AS document_date,\\n  s.wflow_status AS workflow_status,\\n  s.staff_desc AS salesperson,\\n  s.notes_memo AS remarks\\nFROM scm_sal_main AS s\\nWHERE s.tag_deleted_yn = 'n'\\n  AND s.tag_table_usage = 'sal_inv'\\n  AND upper(trim(s.dnum_auto)) = upper(trim('SIV12398'));\",",
                  "  \"sql_results\": [",
                  "    {",
                  "      \"label\": \"Query 1\",",
                  "      \"rowCount\": 1,",
                  "      \"columns\": [\"DOCUMENT_NUMBER\", \"CUSTOMER_NAME\", \"DOCUMENT_DATE\", \"WORKFLOW_STATUS\", \"SALESPERSON\", \"REMARKS\"],",
                  "      \"sampleRows\": [",
                  "        {",
                  "          \"DOCUMENT_NUMBER\": \"SIV12398\",",
                  "          \"CUSTOMER_NAME\": \"Advent Devices (Asia) Pte. Ltd.\",",
                  "          \"DOCUMENT_DATE\": \"2025-01-01T00:00:00+08:00\",",
                  "          \"WORKFLOW_STATUS\": \"drf\",",
                  "          \"SALESPERSON\": \"Jacqueline Hu\",",
                  "          \"REMARKS\": \"t6tteases\"",
                  "        }",
                  "      ]",
                  "    }",
                ...
                assistant: [
                  "ERP Assistant Summary 🧾",
                  "- Document No. 文件號碼: SIV12398",
                  "- Customer 客戶: Advent Devices (Asia) Pte. Ltd.",
                  "- Date 日期: 1 Jan 2025",
                  "- Status 狀態: drf (Draft 草稿, 尚未送審)",
                  "- Salesperson 業務: Jacqueline Hu",
                  "- Remarks 備註: t6tteases",
                  "",
                  "System Insight 💡",
                  "- 目前單據 still in draft, 建議儘快確認資訊後送審。",
                  "- drf 狀態下內容可再修改, 避免延誤 downstream billing。",
                  "- 若需要我可協助提醒 salesperson 跟進。",
                  "",
                  "Executed SQL",
                  "```sql",
                  "SELECT",
              ...
              },
              {
                user: [
                  "{",
                  "  \"question\": \"summarize recent approved invoices\",
                  "  \"plan\": [\"sql\", \"summary\"],",
                  "  \"clarify_question\": null,",
                  "  \"sql_executed\": \"SELECT\\n  s.dnum_auto,\\n  s.party_desc,\\n  s.date_trans,\\n  s.wflow_status,\\n  s.gtotal_amount\\nFROM scm_sal_main AS s\\nWHERE s.tag_deleted_yn = 'n'\\n  AND s.tag_table_usage = 'sal_inv'\\n  AND s.wflow_status = 'cir'\\nORDER BY s.date_trans DESC\\nLIMIT 3;\",",
                  "  \"sql_results\": [",
                  "    {",
                  "      \"label\": \"Query 1\",",
                  "      \"rowCount\": 3,",
                  "      \"columns\": [\"DNUM_AUTO\", \"PARTY_DESC\", \"DATE_TRANS\", \"WFLOW_STATUS\", \"GTOTAL_AMOUNT\"],",
                  "      \"sampleRows\": [",
                  "        {",
                  "          \"DNUM_AUTO\": \"SIV10001\",",
                  "          \"PARTY_DESC\": \"Acme Labs\",",
                  "          \"DATE_TRANS\": \"2025-02-10T16:20:00+08:00\",",
                  "          \"WFLOW_STATUS\": \"cir\",",
                  "          \"GTOTAL_AMOUNT\": 12850.75",
                  "        },",
                  "        {",
                  "          \"DNUM_AUTO\": \"SIV10000\",",
                  "          \"PARTY_DESC\": \"Beta Retail\",",
                  "          \"DATE_TRANS\": \"2025-02-09T09:15:00+08:00\",",
                  "          \"WFLOW_STATUS\": \"cir\",",
                  "          \"GTOTAL_AMOUNT\": 5420.1",
                  "        }",
                  "      ]",
                  "    }",
                  "  ],",
                ...
                assistant: [
                  "ERP Assistant Summary 🧾",
                  "- 最近核准 Approved 單據共 3 筆",
                  "- 最新單 Latest Doc: SIV10001 for Acme Labs on 10 Feb 2025",
                  "- 總金額 Total: 約 18,270.85 (currency 根據系統設定)",
                  "- Workflow 狀態: cir (Certified 已核准)",
                  "",
                  "System Insight 💡",
                  "- cir 代表已完成審核, 可進行開立發票或後續 billing。",
                  "- 兩筆發生在 past 48hrs, keep an eye on cash collection window.",
                  "- 若要追蹤實際收款, 可以叫我查 AR aging。",
                  "",
                  "Executed SQL",
                  "```sql",
                  "SELECT",
