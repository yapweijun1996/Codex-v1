(function(){
  ...
  const ImageInsertUI=(function(){
    ...
    function create(inst, ctx){
      ...
      heading.textContent="Add an image";
      ...
      row.style.gap="8px";
      const uploadBtn=WDom.btn("Upload image", true, "Upload an image from your device");
      ...
      const urlBtn=WDom.btn("Link from URL", false, "Insert image from a URL");
      ...
      urlBtn.style.padding="10px 12px";
      const fileInput=document.createElement("input");
      fileInput.type="file";
      ...
      helper.style.font="11px/1.45 Segoe UI,system-ui";
      helper.style.color=WCfg.UI.textDim;
      helper.style.background="#fff";
      helper.style.borderRadius="8px";
      helper.style.padding="8px 10px";
      helper.style.boxShadow="inset 0 0 0 1px "+WCfg.UI.borderSubtle;
      helper.textContent="Upload from your device or paste a web link. Drag the corners after inserting to resize.";
