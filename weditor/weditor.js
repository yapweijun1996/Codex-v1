(function(){
  ...
  const ImageInsertUI=(function(){
    ...
    function create(inst, ctx){
      ...
      helperIcon.textContent="ℹ";
      helperIcon.setAttribute("aria-hidden","true");
      helperIcon.style.fontSize="12px";
      helperIcon.style.lineHeight="1";
      helperIcon.style.color=WCfg.UI.brand;
      const helperText=document.createElement("span");
      helperText.textContent="Tip: upload a file or paste a link, then drag to reposition or resize.";
      helper.appendChild(helperIcon);
      helper.appendChild(helperText);
      helper.title="Upload from your computer or paste a link. Drag the image or use the corner handles to resize.";
