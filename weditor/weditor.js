      ...
      function applyAdaptiveSizing(){
        ...
        for(let i=0;i<pages.length;i++){
          ...
          if(adaptiveCandidate && i===0){
            ...
            if(pg.content){
              pg.content.style.position="relative";
              pg.content.style.left="";
              pg.content.style.right="";
              pg.content.style.top="";
              pg.content.style.bottom="";
              pg.content.style.width="";
              pg.content.style.height="";
              pg.content.style.minHeight="";
              pg.content.style.maxHeight="";
              pg.content.style.padding=PAD+"px";
              pg.content.style.overflow="visible";
            }
            ...
            if(pg.content){
              pg.content.style.position="absolute";
              pg.content.style.left="0";
              pg.content.style.right="0";
              pg.content.style.top=(pg.headerHeight||0)+"px";
              pg.content.style.bottom=(pg.footerHeight||0)+"px";
              pg.content.style.padding=PAD+"px";
              pg.content.style.overflow="hidden";
            }
          }
        }
      }
