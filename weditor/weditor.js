    ...
    function attach(editor){
      ...
      function dispatchInput(){
        ...
        if(typeof InputEvent==="function"){
          try {
            const ev=new InputEvent("input", { bubbles:true, inputType:"insertReplacementText" });
      ...
      function startResize(spec, handleEl, ev){
        ...
        const startRatio=startHeight>0 ? (startWidth/startHeight) : null;
        ...
        function applySize(width, height){
          ...
          const mutated=(Math.round(prevWidth)!==widthPx || Math.round(prevHeight)!==heightPx);
