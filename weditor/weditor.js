(function(){
  ...
  const WCfg=(function(){
    ...
    const Style={
      ...
      hfPreviewPage:{ width:"min(520px, 100%)", borderRadius:"12px", border:"1px solid "+UI.borderSubtle, background:"#fff", boxShadow:"0 8px 20px rgba(0,0,0,.08)", padding:"24px 24px 18px", boxSizing:"border-box", display:"flex", flexDirection:"column", gap:"18px" },
