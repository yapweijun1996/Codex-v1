        ...
        for(let i=0;i<pages.length;i++){
          ...
          if(adaptiveCandidate && i===0){
            ...
            if(contentEl){
              ...
              contentEl.style.left="0";
              contentEl.style.right="0";
              const topOffset = pg.headerNode ? Math.max(0, pg.headerHeight||0) : 0;
              const bottomOffset = pg.footerNode ? Math.max(0, pg.footerHeight||0) : 0;
              contentEl.style.top = topOffset+"px";
              contentEl.style.bottom = bottomOffset+"px";
