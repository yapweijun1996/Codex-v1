(function(){
  ...
  const WCfg=(function(){
    ...
    const Style={
      ...
      pageFrame:"background:#fff;border:1px solid "+UI.border+";border-radius:8px;box-shadow:0 0 0 20px #fff,0 6px 18px rgba(0,0,0,.08);position:relative;overflow:hidden;margin:0px",
