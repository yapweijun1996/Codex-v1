(function(){
  ...
  const ImageInsertUI=(function(){
    ...
    function create(inst, ctx){
      ...
      helper.textContent="Upload a file or add a link, then resize inside the page.";
