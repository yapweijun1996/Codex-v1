(function(){
  ...
  const Paginator=(function(){
    ...
    function paginate(rawHTML, state){
      ...
      const pageBreakHTML="<div class=\"weditor_page-break\" aria-hidden=\"true\" style=\"page-break-before:always;height:0;margin:0;padding:0;border:0;\"></div>";
      let pagesHTML="";
      for(let i=0;i<pages.length;i++){
  ...
  const PAGED_PRINT_STYLES = "div[data-page]{border-radius:0!important;box-shadow:none!important;border:none!important;outline:none!important;}div[data-page]:not([data-page=\"1\"]){page-break-before:always;}div[data-page=\"1\"]{page-break-before:auto;}.weditor_page-break{display:block;height:0;margin:0;padding:0;border:0;page-break-before:always;}.weditor_page-header,.weditor_page-footer{border:none!important;box-shadow:none!important;}.weditor_page-header{border-bottom:0!important;}.weditor_page-footer{border-top:0!important;}";
