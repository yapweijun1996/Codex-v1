(function(){
  ...
  const HFEditor=(function(){
    ...
    function renderFooterLogoWithPagePreview(inst){
      ...
      return '<div style="display:flex;flex-direction:column;align-items:center;gap:6px;width:100%;text-align:center;">'+
        '<div style="width:100%;display:flex;justify-content:center;align-items:center;">'+
          '<img src="'+src+'" alt="Footer banner" style="width:100%;height:auto;object-fit:contain;border-radius:6px;">'+
        '</div>'+
        '<div style="width:100%;display:flex;align-items:center;justify-content:space-between;gap:12px;font-size:12px;color:#605e5c;flex-wrap:wrap;">'+
          '<span style="flex:1 1 0;text-align:left;opacity:.7;font-style:italic;">Left label</span>'+
          '<span style="flex:1 1 0;text-align:center;opacity:.7;font-style:italic;">Center note</span>'+
          '<span style="flex:1 1 0;text-align:right;">Page {{page}} / {{total}}</span>'+
        '</div>'+
      '</div>';
    }
    function renderFooterLogoWithPageHTML(inst){
      const src=escapeAttribute(resolveFooterLogo(inst));
      return '<div style="width:100%;display:flex;flex-direction:column;align-items:center;gap:8px;text-align:inherit;">'+
        '<div style="width:100%;display:flex;justify-content:center;align-items:center;">'+
          '<img src="'+src+'" alt="Footer banner" style="width:100%;height:auto;object-fit:contain;display:block;">'+
        '</div>'+
        '<div style="width:100%;display:flex;align-items:center;justify-content:space-between;gap:12px;font-size:12px;color:#605e5c;flex-wrap:wrap;">'+
          '<span style="flex:1 1 0;text-align:left;">&nbsp;</span>'+
