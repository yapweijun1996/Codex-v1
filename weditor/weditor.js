(function(){
  ...
  const TableCellPaddingUI=(function(){
    ...
    function create(inst, ctx){
      ...
      panel.style.gridTemplateColumns="minmax(0, 148px) auto";
      panel.style.columnGap="16px";
      ...
      sideWrap.style.justifyContent="center";
      panel.appendChild(sideWrap);
