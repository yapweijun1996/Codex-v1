(function(){
  ...
  const PAGED_PRINT_STYLE_TAG = "<style>"+PAGED_PRINT_STYLES+"</style>";
  const PAGED_PRINT_STYLE_BLOCK = "<div style=\"display:none;\">"+PAGED_PRINT_STYLE_TAG+"</div>";
